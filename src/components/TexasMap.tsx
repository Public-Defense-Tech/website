...
import { X, Gavel, Scale, FileCheck, FileX, Calendar, DollarSign, Users } from "lucide-react";
        ...
        <AnimatePresence mode="wait">
          {selectedData ? (
                  ...
                  <Grid item xs={12} md={4}>
                    <Stack spacing={1.5}>
                      <Box sx={{ p: 2, bgcolor: '#f8fafc', borderRadius: 3, border: '1px solid #f1f5f9' }}>
                        <Stack spacing={1.5}>
                          <Box>
                            <Typography variant="caption" sx={{ fontWeight: 800, color: '#64748b', display: 'flex', alignItems: 'center', gap: 1, mb: 0.5 }}>
                          ...
                          <Box>
                            <Typography variant="caption" sx={{ fontWeight: 800, color: '#64748b', display: 'block', mb: 1 }}>DELIVERY SYSTEMS</Typography>
                            <Stack direction="row" spacing={0.5} flexWrap="wrap">
                              ...
                              ) : <Typography variant="body2" color="text.secondary" sx={{ fontWeight: 500 }}>Traditional</Typography>}
                            </Stack>
                          </Box>
                        </Stack>
                      </Box>
                      ...
                      <Box sx={{ p: 2, bgcolor: 'rgba(34, 197, 94, 0.04)', borderRadius: 3, border: '1px solid rgba(34, 197, 94, 0.1)' }}>
                        <Stack spacing={1.5}>
                          <Box>
                            <Typography variant="caption" sx={{ fontWeight: 800, color: '#166534', display: 'flex', alignItems: 'center', gap: 1, mb: 0.5 }}>
                          ...
                          <Box>
                            <Typography variant="caption" sx={{ fontWeight: 800, color: '#166534', display: 'block', mb: 0.5 }}>NET PER CAPITA</Typography>
                            <Typography variant="h6" sx={{ fontWeight: 700, color: '#14532d' }}>
            ...
            <Box sx={{ py: 8, border: '2px dashed #e2e8f0', borderRadius: 4, textAlign: 'center', bgcolor: '#fcfcfc' }}>
              <Typography sx={{ color: '#94a3b8', fontWeight: 500 }}>Select a county on the map to view indigent defense and court activity data</Typography>
            </Box>
          )}
        </AnimatePresence>
      </Box>
